...
# X_tr / y_tr / X_va / y_va — те же обозначения, что в протоколах из §6
...
Что получилось на нашем стенде — по три запуска каждого варианта с сидами 0, 1, 2, бюджет
60 испытаний, средние значения:

```
метод                 val     test   деревьев время, c
random             0.9614   0.9563      24300      139
tpe                0.9624   0.9571      24300      271
tpe+hyperband      0.9625   0.9572      10360      116
```

Четыре вывода, и каждый пригодится на собеседовании.

**TPE действительно выигрывает у случайного поиска, но немного.** Плюс 0,0010 на валидации
и 0,0008 на тесте — при том, что шум одной валидационной оценки равен 0,0027. Само по себе
это выглядело бы как ничто, но выигрыш **воспроизвёлся на всех трёх сидах** (0,9620 / 0,9626 /
0,9624 против 0,9615 / 0,9614 / 0,9612), и это то, что делает его настоящим. Отсюда правило:
любое сравнение методов HPO гоняйте минимум на трёх сидах, иначе вы сравниваете удачу
одного розыгрыша.

**Прунинг стоит почти ничего и окупается всегда.** Та же метрика, что у чистого TPE, за 10 360
обученных деревьев вместо 24 300 и за 116 секунд вместо 271. Единственное допущение —
ранговая согласованность прокси, которую вы всё равно померили в [§7.4](#74-multi-fidelity-дешёвый-прокси-вместо-полного-обучения).
...
271 секунду против 139. Причина в том, что TPE довольно быстро уходит в область большого
