...
цвет: $\color{#348FEA}{G_j}$ синий, $\color{#E06A27}{H_j}$ оранжевый. Тот же цвет вы увидите
и в формулах, и в тексте вокруг них.

$$
\color{#348FEA}{G_j} = \sum_{i \in I_j} g_i, \qquad \color{#E06A27}{H_j} = \sum_{i \in I_j} h_i
$$

Тогда для каждого листа получаем независимую квадратичную функцию одной переменной
$\varphi(w_j) = \color{#348FEA}{G_j} w_j + \tfrac12 (\color{#E06A27}{H_j} + \lambda) w_j^2$.
Приравниваем производную к нулю:

$$
\varphi'(w_j) = \color{#348FEA}{G_j} + (\color{#E06A27}{H_j} + \lambda) w_j = 0
\qquad\Longrightarrow\qquad
\boxed{\;w_j^{*} = -\frac{\color{#348FEA}{G_j}}{\color{#E06A27}{H_j} + \lambda}\;}
$$
...
Чем больше $\color{#E06A27}{H_j}$, тем осторожнее шаг: гессиан здесь работает как мера
надёжности листа.
