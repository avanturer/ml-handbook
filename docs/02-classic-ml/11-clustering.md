...
**Предварительно нужно:** [линейная алгебра](../01-math/01-linear-algebra.md), [теория вероятностей](../01-math/02-probability.md), [оптимизация](../01-math/04-optimization.md), [SVM, kNN и наивный Байес](10-svm-knn-bayes.md) (метрики близости и проклятие размерности)
...
алгоритма. Смена масштаба одного признака переворачивает разбиение целиком (увидим на числах в [§5](#5-чувствительность-к-масштабу-и-к-форме)).
...
> Единственное неочевидное место — что делать с пустым кластером; см. [§13](#13-подводные-камни).
...
```
[31346.3 18368.7 16516.3 15622.8 14841.7 13970.  12930.9 11752.9 10474.7
  9179.1  8618.8  8412.8  8337.2  8314.2]
...
```
 ...
 k-means++: среднее     39247  лучшее     37817  худшее     52123  доля хороших запусков 0.90
```
...
(см. [§8 предыдущей главы](10-svm-knn-bayes.md#8-проклятие-размерности-численная-демонстрация)):
...
K= 50  ARI=0.146  NMI=0.527  silhouette=0.328
```
...
(см. [главу о снижении размерности](12-dimensionality-reduction.md)).
...
в его локальном оптимуме. На вытянутых кластерах из [§5.2](#52-форма) это ронит ARI с 1.0 до 0.015.
...
даже когда истинных кластеров четыре — в [§11](#11-выбор-числа-кластеров) это видно на числах.
...
⬅️ [SVM, kNN и наивный Байес](10-svm-knn-bayes.md) | 🏠 [Оглавление](../index.md) | ➡️ [Снижение размерности](12-dimensionality-reduction.md)
