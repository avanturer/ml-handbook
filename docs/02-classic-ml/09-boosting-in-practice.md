...
> [предыдущей главы](08-gradient-boosting.md), но на реальных данных дают разное качество, разную
...
**Предварительно нужно:** [градиентный бустинг](08-gradient-boosting.md), [решающие деревья](06-decision-trees.md), [валидация и утечки](05-validation-and-leakage.md)
...
Вспомним целевую функцию шага после разложения Тейлора ([глава 07, §5.1](08-gradient-boosting.md#51-разложение-тейлора)):
...
⬅️ [Градиентный бустинг](08-gradient-boosting.md) | 🏠 [Оглавление](../index.md) | ➡️ [SVM, kNN и наивный Байес](10-svm-knn-bayes.md)
