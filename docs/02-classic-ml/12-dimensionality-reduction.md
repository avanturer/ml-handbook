...
**Предварительно нужно:** [линейная алгебра](../01-math/01-linear-algebra.md), [постановка задачи обучения](01-learning-theory.md), [кластеризация](11-clustering.md)
**Как проработать:** чтение + вывод формул руками + эксперименты с картинками
...
одинаковыми (подробный разбор проклятия размерности — в [главе про SVM и kNN](10-svm-knn-bayes.md)).
...
> 🌱 **База.** Если вы впервые видите тему, читайте по этому маршруту: раздел 2 (что такое PCA
> и зачем центрировать), раздел 3 до первой формулы Лагранжа, раздел 6 (сколько компонент брать),
> раздел 7 (код), список «что нельзя читать по картинке t-SNE» в разделе 8 и раздел 12
> (когда снижение размерности вредит). Выводы в разделах 4 и 5 пропустите — вернётесь к ним,
> когда понадобится отвечать на «выведите PCA» на собеседовании. Практическая интуиция:
> PCA — это как сфотографировать трёхмерный объект с ракурса, с которого он выглядит крупнее
> всего. Часть информации о глубине теряется, но силуэт сохраняется лучше, чем с любого
> другого ракурса.
...
[главе о валидации и утечках](05-validation-and-leakage.md).
...
> и любой обучаемой предобработки. Разбор — в [главе о валидации](05-validation-and-leakage.md).
...
⬅️ [Кластеризация](11-clustering.md) | 🏠 [Оглавление](../index.md) | ➡️ [Дисбаланс классов и калибровка](13-imbalance-and-calibration.md)
