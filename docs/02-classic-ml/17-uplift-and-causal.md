...
**Предварительно нужно:** [статистика](../01-math/03-statistics.md), [метрики качества](04-metrics.md), [градиентный бустинг](08-gradient-boosting.md), [валидация и утечки](05-validation-and-leakage.md)
...
кластерная рандомизация — см. [сложные схемы A/B](../06-ab-testing/05-complex-designs.md).
...
фича раскатана на часть платформ. См. также [квазиэксперименты](../06-ab-testing/05-complex-designs.md).
...
бандиты, см. [эксплорация и бандиты](../10-recsys/13-exploration-and-bandits.md).
