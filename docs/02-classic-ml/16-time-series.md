...
**Предварительно нужно:** [теория вероятностей](../01-math/02-probability.md), [статистика](../01-math/03-statistics.md), [валидация и утечки](05-validation-and-leakage.md), [работа с признаками](14-feature-engineering.md), [градиентный бустинг](08-gradient-boosting.md)
**Как проработать:** чтение + вывод формул + сборка пайплайна
...
> $\ell_t = \alpha y_t + (1-\alpha)[\alpha y_{t-1} + (1-\alpha)\ell_{t-2}] = > \alpha y_t + \alpha(1-\alpha) y_{t-1} + (1-\alpha)^2 \ell_{t-2}$. Продолжая, получаем ровно
...
> [валидация и утечки](05-validation-and-leakage.md).
