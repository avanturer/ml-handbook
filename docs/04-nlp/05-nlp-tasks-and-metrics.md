...
[главе про офлайн-метрики рекомендаций](../10-recsys/02-metrics-offline.md). Ключевые:
...
сплит по автору/организации. См. [валидацию и утечки](../02-classic-ml/05-validation-and-leakage.md).
