...
Итоговый eCPM для них: $\mathrm{eCPM} = \text{target CPA} \cdot \hat p_{\text{click}} \cdot
\hat p_{\text{conv}|\text{click}} \cdot 1000$. У CVR-модели своя большая проблема — задержка
конверсий, см. §10.3.
