...
**Предварительно нужно:** [каркас ответа](01-framework.md), [текст как данные](../04-nlp/01-text-representation.md), [эмбеддинги](../04-nlp/02-embeddings.md), [обучение ранжированию](../06-recsys/07-learning-to-rank.md), [двухбашенные модели и ANN](../06-recsys/06-two-tower-and-ann.md)
...
фильтрами, реализуйте каскад релаксации из §7 и измерьте, сколько процентов запросов чинится
на каждом шаге.
...
- [Huang et al. «Embedding-based Retrieval in Facebook Search» (KDD 2020)](https://arxiv.org/abs/2006.11632) —
  ...
  обслуживание индекса. Прямо соответствует §6 этой главы.
...
- **Joachims, Swaminathan, Schnabel. «Unbiased Learning-to-Rank with Biased Feedback» (WSDM 2017)** —
  формальная постановка IPS для ранжирования и оценка propensity; основа §10.4.
...
- Смежные главы: [обучение ранжированию](../06-recsys/07-learning-to-rank.md),
  [двухбашенные модели и ANN](../06-recsys/06-two-tower-and-ann.md),
