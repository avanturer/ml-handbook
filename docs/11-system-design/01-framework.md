...
и пройдите все восемь шагов вслух, засекая время по таблице из §2. Записывайте себя на диктофон.
...
Прослушайте запись из задачи 1 с таблицей из §11 в руках и отметьте для каждой строки,
на каком вы уровне.
