...
<details>
<summary><b>🧠 Вопрос.</b> Вам предлагают грейд ниже, чем вы рассчитывали. Что делаете?</summary>

**Короткий ответ.** Спрашиваю, какие именно ожидания не подтвердились и чем на их шкале
отличаются соседние ступени. Дальше либо привожу недостающие доказательства, либо обсуждаю
условия пересмотра через понятный срок.

**Развёрнуто.** Грейд собирается из оценок по секциям, и чаще всего вниз его тянет не техника,
а отсутствие свидетельств влияния и автономности: нет историй о том, как вы сами формулировали
задачу, спорили о метрике, отказывались от лишней сложности. Поэтому первый ход — уточняющий
вопрос, а не спор: «Что в моём профиле не дотянуло до следующей ступени?» Если причина — конкретный
пробел, о нём можно договориться письменно: какие результаты за какой срок дают пересмотр.
Если причина — «нам не было видно вашего влияния», это ваш урок к следующему процессу:
готовить не только формулы, но и банк историй (см. [следующую главу](02-behavioral.md)).

**Чего ждёт интервьюер:** зрелой реакции вместо торга «дайте больше, я же сеньор».

**Провал:** обидеться и уйти молча либо согласиться, ничего не выяснив, и вернуться
...
Заполните скрипт из [§6](#6-тайминг-план-на-восемь-недель) своими конверсиями (или плейсхолдерами, если данных ещё нет) и посчитайте,
...
Возьмите пять реальных вакансий вашего уровня и разметьте каждую по таблице флагов из [§9](#9-красные-флаги-в-вакансии-и-в-процессе).
...
- [Короткие маршруты](../00-start/02-tracks.md) — что читать сначала, если времени мало;
  сюда же встраивается календарь из [§6](#6-тайминг-план-на-восемь-недель).
