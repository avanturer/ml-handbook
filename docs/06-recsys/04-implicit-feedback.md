...
**Время на проработку:** ~7 часов (чтение + два вывода руками + реализация iALS и BPR)
...
| Данные очень разреженные, $|N(u)| < 5$ у большинства | iALS с сильной регуляризацией | сэмплирующие методы на коротких историях нестабильны |
