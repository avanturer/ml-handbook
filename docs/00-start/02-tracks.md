...
> **Зачем эта глава.** Основной способ пройти книгу — [подряд](01-how-to-use.md#4-как-читать):
> части выстроены по зависимостям, и в конце вы знаете то, что спрашивают с middle+ MLE.
> Но бывают ситуации, когда прочитать всё сразу нельзя: собеседование на следующей неделе,
> половина книги уже знакома, нужен срез под конкретную вакансию. Здесь собраны маршруты
> для таких случаев — подмножества книги с расставленными приоритетами и с критерием
> «маршрут пройден». Маршрут не заменяет книгу: он говорит, что читать **сначала**.
...
- [Как выбрать маршрут](#как-выбрать-маршрут)
...
Сначала честный вопрос к себе: точно ли нужен маршрут? Если до собеседования больше месяца
и книга для вас новая — не нужен, идите подряд, это быстрее и надёжнее. Маршрут оправдан,
когда есть жёсткое ограничение по времени или когда значительная часть материала уже своя.

Если ограничение есть — ответьте на два вопроса честно.
