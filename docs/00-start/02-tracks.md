...
**Уровень:** для всех
**Время на проработку:** ~20 минут на выбор трека
...
**Вопрос 2: сколько часов в неделю вы реально готовы вкладывать?**
Не «хотел бы», а реально. Оценки времени в треках даны из расчёта **8–10 часов в неделю**.
Если у вас 4 — умножайте сроки на два и не расстраивайтесь: регулярность важнее интенсивности.
...
**Срок:** 4–5 месяцев по 8–10 ч/нед.

### Этап 1 — фундамент (5 недель)
...
### Этап 2 — деревья и ансамбли (4 недели)
...
### Этап 3 — работа с данными (4 недели)
...
### Этап 4 — код и SQL (3 недели, параллельно с этапом 3)
...
### Этап 5 — минимум про прод (3 недели)
...
### Этап 6 — нейросети обзорно (2 недели)
...
**Срок:** 2,5–3 месяца по 8–10 ч/нед.

### Этап 1 — закрыть глубину в классике (2 недели)
...
### Этап 4 — эксперименты (1,5 недели)
...
### Этап 5 — данные в масштабе (2 недели)
...
### Этап 7 — профильная глубина (2 недели)
