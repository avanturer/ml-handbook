...
технологий. Ориентир — таблица из [§3](#3-что-меняется-от-грейда-к-грейду).
...
- [Короткие маршруты](02-tracks.md) — если собеседование близко и нужен срез, а не полный проход.
...
⬅️ [Короткие маршруты](02-tracks.md) | 🏠 [Оглавление](../index.md) | ➡️ [Как учить, чтобы осталось в голове](04-study-method.md)
