...
**Уровень:** 🌱 база → 🎯 middle
**Предварительно нужно:** [Постановка задачи обучения](../02-classic-ml/01-learning-theory.md), [Метрики качества](../02-classic-ml/04-metrics.md), [Валидация и утечки](../02-classic-ml/05-validation-and-leakage.md)
...
⬅️ [Справедливость и систематические смещения](../09-monitoring/08-fairness.md) | 🏠 [Оглавление](../index.md) | ➡️ [Офлайн-метрики рекомендаций](02-metrics-offline.md)
