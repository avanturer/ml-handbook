...
**Время на проработку:** ~8 часов (сначала решить самому, потом сверяться)
...
Поднимите PostgreSQL в Docker, создайте схему из §2 и сгенерируйте синтетические данные:
