...
**Предварительно нужно:** [Computer Vision](01-computer-vision.md), [эмбеддинги](../04-nlp/02-embeddings.md), [двухбашенные модели и ANN](../10-recsys/06-two-tower-and-ann.md), [устройство LLM](../05-llm/01-llm-architecture.md)
...
механизм, что в [двухбашенных моделях](../10-recsys/06-two-tower-and-ann.md) в рекомендациях, —
...
2. **Zero-shot классификация.** Классы описываются словами, а не примерами (см. [§4](#4-zero-shot-классификация)).
...
Архитектура ровно та же, что у [двухбашенных моделей](../10-recsys/06-two-tower-and-ann.md),
...
[холодный старт](../10-recsys/12-cold-start-and-bias.md).
...
Реализуйте `clip_loss` из [§2](#2-контрастивное-обучение-и-infonce), не подглядывая, и проверьте три инварианта: при совпадающих
