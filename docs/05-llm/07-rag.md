...
[двухбашенные модели и ANN-поиск](../06-recsys/06-two-tower-and-ann.md),
[промптинг](06-prompting-and-structured-output.md), [метрики качества](../02-classic-ml/04-metrics.md)
**Время на проработку:** ~7 часов (чтение + сборка минимального пайплайна + прогон оценки)
...
- [9. Сборка контекста: сколько, в каком порядке](#9-сборка-контекста-сколько-в-каком-порядке) — lost in the middle
...
| Dense-поиск, ANN, $n \sim 10^6$ | 5–30 мс | HNSW; см. [ANN-поиск](../06-recsys/06-two-tower-and-ann.md) |
...
а устройство ANN-индексов — в главе про [двухбашенные модели и ANN-поиск](../06-recsys/06-two-tower-and-ann.md).
...
5. **Дообучение эмбеддера.** Самый недооценённый рычаг. Если у вас доменный жаргон, внутренние
   ...
   документам, дообучить контрастивно (см. [двухбашенные модели](../06-recsys/06-two-tower-and-ann.md)
...
(см. [постановку задачи рекомендаций](../06-recsys/01-recsys-foundations.md)): дешёвый ретривер
...
Полный разбор этих метрик — в главе про [офлайн-метрики рекомендаций](../06-recsys/02-metrics-offline.md);
...
- [Malkov, Yashunin. «Efficient and robust approximate nearest neighbor search using HNSW graphs» (2016)](https://arxiv.org/abs/1603.09320) —
  ...
  в главе про [ANN-поиск](../06-recsys/06-two-tower-and-ann.md).
