...
> ⚠️ **Почему нельзя просто использовать эту формулу.** $Z(x)$ — сумма по всем текстам. Её нельзя
> посчитать и нельзя из неё сэмплировать. Формула красива, но напрямую бесполезна. Дальше — трюк,
> который делает её полезной.
...
**Развёрнуто, по слоям с ценой и ограничениями.**
