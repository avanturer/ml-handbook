...
страховой андеррайтинг, отбор резюме, медицинская триажная система, антифрод с блокировкой
счёта — здесь метрики справедливости стоят рядом с ROC-AUC и имеют право заблокировать релиз.
