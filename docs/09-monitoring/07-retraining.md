...
**Предварительно нужно:** [дрифт данных](03-drift-detection.md), [деградация модели](04-model-degradation.md), [инциденты](06-incidents-and-runbooks.md), [валидация и утечки](../02-classic-ml/05-validation-and-leakage.md), [CI/CD для ML](../07-mlops/07-ci-cd-for-ml.md)
...
см. [ловушки A/B](../06-ab-testing/04-pitfalls.md)).
...
- бандиты и эксплорация, где адаптация — суть метода
  (см. [бандиты](../10-recsys/13-exploration-and-bandits.md));
...
(см. [дизайн эксперимента](../06-ab-testing/01-experiment-design.md)), и решение
...
[дизайне эксперимента](../06-ab-testing/01-experiment-design.md)):
