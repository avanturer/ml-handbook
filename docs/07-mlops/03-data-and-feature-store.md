...
> Дальше можно читать §4 медленно; всё остальное в главе — про то, как сделать эту проверку
...
- **офлайн-стор** обслуживает обучение и батч-скоринг, умеет отвечать на вопрос
  «какое значение фичи было на момент $t$» (см. §4);
...
проверки кодом (по образцу §2 или через Great Expectations) и встройте их в пайплайн
...
- [Feast. Документация](https://docs.feast.dev/) — открытый feature store. Читать разделы
  ...
  и про материализацию: там формализовано ровно то, что разобрано в §4 и §6, включая
...
- [Google. «Rules of Machine Learning»](https://developers.google.com/machine-learning/guides/rules-of-ml) —
  ...
  во время сервинга, и подавать эти признаки в лог») — это ровно механизм из §5.
...
- **Martin Kleppmann. «Designing Data-Intensive Applications»** — глава 4 (Encoding
  and Evolution) — первоисточник по режимам совместимости схем из §2, разобранный
  гораздо подробнее.
