...
- [5. Уровни зрелости MLOps 0 / 1 / 2](#5-уровни-зрелости-mlops-0--1--2)
- [6. Что ломается на каждой стадии](#6-что-ломается-на-каждой-стадии)
- [7. Антипаттерн «ноутбук в проде»](#7-антипаттерн-ноутбук-в-проде)
- [8. Вывод из эксплуатации](#8-вывод-из-эксплуатации)
...
### 4.7. Нестабильные и недоиспользуемые зависимости от данных
...
## 6. Что ломается на каждой стадии
