...
| **Учебник по ML ШАДа** | https://education.yandex.ru/handbook/ml | 2021→наст. вр. | **Главный русскоязычный канон.** Прямо позиционируется как «продвинутый учебник без упрощений, от базовых алгоритмов до тем из свежих статей». На собесах в РФ вопросы часто формулируются его языком. | **[MUST]** junior→middle_plus |
