...
| **Ассоциативные правила: Apriori, FP-growth, support/confidence/lift, анализ корзины** | Dyakonov/MSUML лекция 21; PZAD | Базовый ретейл-инструмент и частый источник «дешёвых» кандидатов в рекомендациях; спрашивают в e-commerce | `docs/10-recsys/01-recsys-foundations.md` или `docs/02-classic-ml/10-clustering.md` |
